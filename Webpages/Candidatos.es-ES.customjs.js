document.addEventListener('DOMContentLoaded', function() {
  ...
  const urlPowerAutomate = "https://defaultc7901014556049efa6893c215c6092.ee.environment.api.powerplatform.com:443/powerautomate/automations/direct/cu/26/workflows/7c10edd6f01347158353595118d78f42/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=OjOHmzHTE7l10V04yvXlpGpwYg3se3yP9JNwXF5h2n0";

  // 1. Autoformato de mayúsculas / minúsculas en tiempo real
  document.addEventListener('input', function(e) {
    if (e.target.tagName === 'INPUT' && e.target.type === 'text') {
      const excludedIds = ['codigoPostal', 'numeroDomicilio', 'correo', 'colonia-input', 'calle'];
      const el = e.target;
  ...
  const camposNumericos = ['codigoPostal', 'telefonoWhatsapp', 'telefonoContactoEmergencia', 'telefonoContactoEmergencia2'];
